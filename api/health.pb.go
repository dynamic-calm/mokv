...
func (HealthCheckResponse_ServingStatus) EnumDescriptor() ([]byte, []int) {
	return file_api_health_proto_rawDescGZIP(), []int{1, 0}
}
...
func (x *HealthCheckResponse) Reset() {
	*x = HealthCheckResponse{}
	mi := &file_api_health_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*HealthCheckResponse) Descriptor() ([]byte, []int) {
	return file_api_health_proto_rawDescGZIP(), []int{1}
}
...
var (
	...
	file_api_health_proto_rawDescData []byte
)

func file_api_health_proto_rawDescGZIP() []byte {
	file_api_health_proto_rawDescOnce.Do(func() {
		file_api_health_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_api_health_proto_rawDesc), len(file_api_health_proto_rawDesc)))
	})
...
func file_api_health_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_api_health_proto_rawDesc), len(file_api_health_proto_rawDesc)),
			NumEnums:      1,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   1,
